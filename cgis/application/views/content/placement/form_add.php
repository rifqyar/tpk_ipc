...
<div class="panel">
  ...
  <div class="panel-body container-fluid">
      <div class="col-sm-12">
        <form name="form_data" id="form_data" class="form-horizontal" role="form" action="<?php echo site_url('execute/process/'.$action.'/lokasi/'.$id); ?>" method="post" autocomplete="off" onsubmit="save_post('form_data','divtblkapal'); return false;" popup="1">
          <div class="panel-body container-fluid">
            <div class="row">
				<table class="table">
				  <tr>
				  ...
				  <tr>
					...
					<td><?php //echo $value->UKURAN ?>
						...
						<div class="form-group form-material">
							<div class="col-sm-9">
							  ...
							  <div class="hint">LOKASI AWAL</div>
							</div>
						</div>
					</td>
					<!--
					...
					<td><?php //echo $value->ISO_CODE ?>
						<div class="form-group form-material">
							<div class="col-sm-9">
							  <input type="text" name="DATA[LOKASI_AKHIR]" id="LOKASI" class="form-control" placeholder="LOKASI AKHIR" value="<?php echo $arrdata['LOKASI_AKHIR']; ?>" maxlength="20">
							  <div class="hint">LOKASI AKHIR</div>
							</div>
						</div>
					</td>
				  </tr>
          ...
          <input type="hidden" name="action" id="action" readonly="readonly" value="<?php echo site_url('planning/placement/post'); ?>"/>
        </form>
      </div>
    </div>
  </div>
