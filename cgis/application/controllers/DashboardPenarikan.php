...
class DashboardPenarikan extends CI_Controller
{
	public $content;
	...
	function status()
	{
		...
		$this->load->model("m_dash_penarikan");
		$arrdata['datalongroom'] = $this->m_dash_penarikan->get_data_kontainer();
		$data = $this->load->view('content/monitoring/rekon_stack_npct1', $arrdata, true);
		echo $data;
	}
}
