...
<div class="panel">
  ...
  <button type="submit" class="btn btn-sm btn-primary navbar-right navbar-btn waves-effect waves-light" onclick="save_post('form_data','divgate'); return false;">
    <i class="icon md-badge-check"></i> SAVE
  </button>
  <div class="panel-body container-fluid">
    <div class="row">
      <div class="col-sm-12">
        <form name="form_data" id="form_data" class="form-horizontal" role="form" action="<?php echo site_url('execute/process/update/'.$action.'/'.$id); ?>" method="post" autocomplete="off" onsubmit="save_post('form_data','divgate'); return false;" popup="1">
          <div class="panel-body container-fluid">
            <div class="row">
...
<!--        <div class="form-group form-material">
              ...
              <div class="form-group form-material">
                ...
                <div class="col-sm-9">
                  <input type="text" name="DATA[NO_DOK]" id="NO_DOK" mandatory="yes" class="form-control" placeholder="NO. DOKUMEN" value="<?php echo trim($arrdata['NO. DOKUMEN']); ?>" >
              ...
              <div class="form-group form-material">
                ...
                <div class="col-sm-9">
                  <input type="text" name="DATA[TGL_DOK]" id="TGL" mandatory="yes" class="form-control" placeholder="TANGGAL DOKUMEN" value="<?php echo trim($arrdata['TGL. DOKUMEN']); ?>" readonly="">
       ...
       <div class="form-group form-material">
              ...
              <div class="form-group form-material">
                ...
                <div class="col-sm-8">
                  <input type="text" name="DATA[NAMA_CUST]" id="NAMA_CUST" mandatory="yes" class="form-control" placeholder="NAMA CUSTOMER" value="<?php echo trim($arrdata['NAMA_CUST']); ?>" readonly="">
              ...
              <div class="form-group form-material">
                ...
                <div class="col-sm-9">
                  <input type="text" name="DATA[NPWP]" id="NPWP" mandatory="yes" class="form-control" placeholder="NPWP" value="<?php echo trim($arrdata['NPWP']); ?>" readonly="">
               ...
               <div class="form-group form-material">
                ...
                <div class="col-sm-4">
                  <input type="text" name="DATA[JNS_KEGIATAN]" id="JNS_KEGIATAN" mandatory="no" class="form-control" placeholder="JENIS KEGIATAN" value="BEHANDLE 1" maxlength="10">
              ...
              <div class="form-group form-material">
                ...
                <div class="col-sm-9">
                  <input type="text" name="DATA[NO_CONT]" id="NO_CONT" mandatory="yes" class="form-control" placeholder="NO. KONTAINER" value="<?php echo $arrdata['NO. KONTAINER']; ?>" maxlength="11">
              ...
              <div class="form-group form-material">
                ...
                <div class="col-sm-9">
                  <input type="text" name="DATA[UKR_CONT]" id="UKR_CONT" mandatory="yes" class="form-control" placeholder="UKURAN KONTAINER" value="<?php echo $arrdata['UKURAN']; ?>" maxlength="2">
