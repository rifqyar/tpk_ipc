		...
		<table class="" cellspacing="1" width="100%" id="tablehide" style="border:2px" class="tablehide" style='display:none;'>
			...
			if ($cekRows > 0) {
				...
				foreach($datalongroom as $value){ 
					...
					if($value->RESPON == '' && $value->WK_RESPON ==''){
						$RESPON_PKB = "-";
						$WK_RESPON_PKB = "-";
					}else{
						$RESPON_PKB = $value->RESPON;
						$WK_RESPON_PKB = $value->WK_RESPON;
					}
			...
			<tr class="<?php echo $class; ?>">
				...
				<td style="text-align:center;"><?php echo $value->JNS_CONT; ?></td>
				...
				<td style="text-align:center;"><?php echo $RESPON_PKB; ?></td>
				<td style="text-align:center;"><?php echo $WK_RESPON_PKB; ?></td>
			</tr>
			<?php 
				} //else for
			} else { //else if
