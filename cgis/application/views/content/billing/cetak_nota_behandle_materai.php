...
$html .= getHTML($result, $title, $result_hdr, $result_cust, $result_cont, $result_materai);
$html .= '</div></body>';
$html .= '</div></body>';
...
$mpdf->WriteHTML($html);
$path = '/home/tpk_ipc/cgis/cetakpdf/'.$result_hdr[0]["NO_NOTA_BEHANDLE"].'.pdf';
$mpdf->Output($path, 'F');
...
function getHTML($result, $title, $result_hdr, $result_cust, $result_cont, $result_materai){
	global $CONF;
...
$box=0;
	...
	$Harga = $result_hdr[0]["SUBTOTAL"] + $result_hdr[0]['BIAYA_ADMIN']+ $result_hdr[0]["SEAL"];
...
$ADMIN=$title;
	$html = '<table border="0" width="100%" cellpadding="0" cellspacing="0"  align="left">
				...
				<tr>
					<td colspan="6" align="left">SEAL</td>
					<td colspan="3" align="center"></td>
					<td colspan="3" align="center"></td>
					<td colspan="3" align="center">'.$box.'</td>
					<td colspan="4" align="right">16,000.00</td>
					<td colspan="2" align="center">IDR</td>
					<td colspan="6" align="right">'.number_format($result_hdr[0]['SEAL'], 2, '.', ',').'</td>
				</tr>
				<tr>
					<td colspan="27" align="center">-----------------------------------------------------------------------------------------</td>
				</tr>
				...
				<tr>
					...
					<td align="center">:</td>
					<td colspan="6" align="right">'.$result_hdr[0]['BIAYA_ADMIN'].'</td>
					<td></td>
				</tr>
				<tr>
					<td colspan="13"></td>
