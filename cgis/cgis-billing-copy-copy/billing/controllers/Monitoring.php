...
class Monitoring extends CI_Controller {
	...
	public function penarikanBaru($act,$id){
		$this->load->view('content/error',$this->index());
	}

	public function filter($act,$id){
		$this->load->view('content/error',$this->index());
	}

	public function longroomOld($act,$id){
		$this->load->view('content/error',$this->index());
	}

	public function longroom($act,$id){
		$this->load->view('content/error',$this->index());
	}
	
	public function filterLongroom($act,$id){
		$this->load->view('content/error',$this->index());
	}
}
