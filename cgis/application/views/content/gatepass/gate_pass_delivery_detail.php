<div class="panel">
  ...
  <div class="panel-body container-fluid">
    <div class="row">
      <div class="col-sm-12">
        <form name="form_data" id="form_data" class="form-horizontal" role="form" action="<?php echo site_url('execute/process/save/gatepass_delivery/'.$id); ?>" method="post" autocomplete="off" onsubmit="save_post('form_data','divgate'); return false;" popup="1">
          <div class="panel-body container-fluid">
            <div class="row">
              ...
              <div class="form-group form-material">
                ...
                <div class="col-sm-9">
                  <input type="text" name="DATA[NO_DOK]" id="NO_DOK" mandatory="yes" class="form-control" placeholder="NO. DOKUMEN" value="<?php echo trim($arrdata['NO_DOK_INOUT']); ?>" readonly="">
              ...
              <div class="form-group form-material">
                ...
                <div class="col-sm-9">
                  <input type="text" name="DATA[TGL_DOK]" id="TGL" mandatory="yes" class="form-control" placeholder="TANGGAL DOKUMEN" value="<?php echo date('d-m-Y',strtotime(trim($arrdata['TGL_DOK_INOUT']))); ?>" readonly="">
	     ...
	     <div class="form-group form-material">
              <label class="col-sm-3 control-label">NAMA KAPAL</label>
                <div class="col-sm-9">
                  <input type="text" name="DATA[NM_KAPAL]" id="NM_KAPAL" mandatory="yes" class="form-control" placeholder="NAMA KAPAL" value="<?php echo trim($arrdata['ANGKUTNAMA_TPS']); ?>" >
	     ...
	     <div class="form-group form-material">
              <label class="col-sm-3 control-label">NO. VOYAGE</label>
                <div class="col-sm-9">
                  <input type="text" name="DATA[NO_VOY]" id="NO_VOY_FLIGHT" mandatory="yes" class="form-control" placeholder="NO. VOYAGE" value="<?php echo trim($arrdata['ANGKUTNO_TPS']); ?>" readonly >
              ...
              <div class="form-group form-material">
                ...
                <div class="col-sm-9">
                  <input type="text" name="DATA[UKR_CONT]" id="UKR_CONT" mandatory="yes" class="form-control" placeholder="UKURAN KONTAINER" value="<?php echo $arrdata['KD_CONT_UKURAN']; ?>" readonly="">
                  <div class="hint">UKURAN KONTAINER</div>
                </div>
              </div>
            </div>
          </div>
          <input type="hidden" name="action" id="action" readonly="readonly" value="<?php echo site_url('planning/get_pass_delivery/post'); ?>"/>
        </form>
      </div>
    </div>
  </div>
