...
<div class="form-fieldset" style="margin: 5px 5px 5px 5px">
	<form name="form_data" id="form_data" class="form-horizontal" role="form" action="<?php echo site_url('billing/cetak_simulasi2/'.$id); ?>" method="post" autocomplete="off" target="_blank">
		<button  type="submit" class="btn btn-sm btn-primary navbar-center navbar-btn waves-effect waves-light">
			<i class="icon md-print"></i> CETAK
		 </button>
	 </form>
	 <br>
        	...
        	<td align="center">
               ...
               <tr height="30">
				...
				<tr>
					...
					<td colspan="3"></td>
					<td colspan="12" align="left">Date Of Stacking : <?php echo date('d-m-Y H:i:s',strtotime($result_hdr[0]["TGL_STACK"]))?></td>
				</tr> 
				<tr>
					<td colspan="3"></td>
					<td colspan="9" align="left">Date Of Document : <?php echo  $result_hdr[0]["TGL_DOK"] ?></td>
					<td colspan="3"></td>
               ...
               <tr height="30">
				...
				<br/>
				<br/>
               <p> <strong><i>This document is printed by CGIS – IPCTPK</i></strong></p>  
                    </div>
                </fieldset>
            </td>
		</tr>
