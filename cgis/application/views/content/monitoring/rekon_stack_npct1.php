...
<head>
	<meta charset="UTF-8">
	<title>Monitoring Penarikan NPCT1</title>
	  ...
	  <div class="panel-body">
		...
		<table class="body" cellspacing="1" width="100%" id="table_scroll" style="border:2px" class="table_scroll" style='display:none;'>
			<tr style="text-align:center;">
				...
				<th style="text-align:center;">JNS DOK</th>
				<th style="text-align:center;">REQUEST CUSTOMER</th>
			</tr>
			<?php 
			...
			<tr class="<?php echo $class; ?>">
				...
				<td style="text-align:center;"><?php echo $value->PERIKSA; ?></td>
				<td style="text-align:center;"><?php echo $value->NO_DOK; ?></td>
				<td style="text-align:center;"><?php echo $value->TGL_DOK; ?></td>
				...
				<td style="text-align:center;font-size: 20px;"><?php echo $value->STATUS_REQUEST; ?></td>
			</tr>
			<?php 
				} //else for
			} else { //else if
