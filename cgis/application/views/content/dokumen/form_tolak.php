        ...
        <div class="row">
            <div class="col-sm-12">
                <form name="form_data" id="form_data" class="form-horizontal" role="form"
                    action="<?php echo 'online/prosesonlinetolak?id='.$arrdata->ID; ?>" method="post" autocomplete="off"
                    ...
                    <input type="hidden" name="action" id="action" readonly="readonly"
                        value="<?php echo site_url('online/prosesonlinetolak'); ?>" />
                    <div class="panel-body container-fluid">
                        <div class="row">
                            <div class="form-group form-material">
                                ...
                                <input type="hidden" name="ID_DOKUMEN" value="<?php echo $arrdata->ID_DOKUMEN;?>">
                            </div>
                        </div>
                    </div>
            </form>
