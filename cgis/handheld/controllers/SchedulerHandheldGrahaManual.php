...
class SchedulerHandheldGrahaManual extends CI_Controller
{
    public $content;
    ...
    public function kirim_graha_terbitSpk()
    {
            ...
            where DATE(T.WK_REQ) >= DATE_ADD(NOW(), interval - 15 day) and LG.no_spk is null and G.WK_FINISH is not null and YEAR(T.TGL_DOK) >= 2020 order by T.NO_SPK asc";
