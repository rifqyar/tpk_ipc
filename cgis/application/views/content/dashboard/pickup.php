...
<html lang="en">
    ...
    <body>
                            ...
                            <div class="row row-card-no-pd mt--2">
                                <div class="col-md-12">
                                    <div class="card">
                                        ...
                                        <?php
                                        echo form_open('PortalDashboard/search_pickup'); 
                                        ?>
                                        <div class="container">
                                                            ...
                                                            <tr>
                                                              ...
                                                              <td id="fl_send_npct1"><?php
                                                                ...
                                                                if ($nilai[$i]['STATUS_CONT'] == '100'&& $nilai[$i]['FL_SEND_NPCT1'] == 'N') {
                                                                  ...
                                                                  echo '<a class="btn btn-success '.$nilai[$i]['NO_CONT'].'" style="display: inherit;">S</a>';
                                                                }
        ...
        <script
            src="<?php echo base_url();?>assets/assets_dashboard/js/pickupjss.js"></script>
    </body>
</html>