...
<div class="container">
  ...
  <table class="table">
      ...
      ?>
	  <tr>
		<td colspan ='2' style="background-color:#3fb5b5;color:#FFF"><b>BEHANDLE 1</b></td>
		<td style="background-color:#3fb5b5;color:#FFF">OPERATOR</td>
      </tr>
	  <!--BEHANDLE 1-->
		<tr>
	  ...
	  <tr>
		...
		<td colspan ='3' style="background-color:#3fb5b5;color:#FFF"><b>REQUEST BEHANDLE 1</b></td>
      </tr>
	   <!--REQUEST BEHANDLE 1-->
		<tr>
	  ...
	  <tr>
		<td colspan ='3' style="background-color:#3fb5b5;color:#FFF"><b>PENARIKAN</b></td>
      </tr>
	   <!--PENARIKAN-->
		<tr>
            <td>PICK UP</td>
	  ...
	  <tr>
		<td colspan ='3' style="background-color:#3fb5b5;color:#FFF"><b>PEMERIKSAAN BEHANDLE 1</b></td>
      </tr>
	  ...
	  <tr>
		<td colspan ='3' style="background-color:#3fb5b5;color:#FFF"><b>REQUEST BEHANDLE 2</b></td>
      </tr>
	  <!--REQUEST BEHANDLE 2-->
		<tr>
            <td>JENIS DOKUMEN</td>
	  ...
	  <tr>
		<td colspan ='3' style="background-color:#3fb5b5;color:#FFF"><b>PEMERIKSAAN BEHANDLE 2</b></td>
      </tr>
	   <!--PEMERIKSAAN BEHANDLE 2-->
		...
		<tr>
			<td colspan ='3' style="background-color:#3fb5b5;color:#FFF"><b>BILLING BEHANDLE 1</b></td>
		</tr>
	   <!--REQUEST BEHANDLE-->
		<tr>
            <td>JENIS DOKUMEN</td>
		...
		<tr>
			<td colspan ='3' style="background-color:#3fb5b5;color:#FFF"><b>BILLING BEHANDLE 2</b></td>
		</tr>
	   <!--REQUEST BEHANDLE 2-->
		<tr>
            <td>JENIS DOKUMEN</td>
		...
		<tr>
			<td colspan ='3' style="background-color:#3fb5b5;color:#FFF"><b>REQUEST BILLING DELIVERY</b></td>
		</tr>
	   <!--REQUEST DELIVERY-->
		<tr>
            <td>JENIS DOKUMEN</td>
		...
		<tr>
			<td colspan ='3' style="background-color:#3fb5b5;color:#FFF"><b>REQUEST BILLING DELIVERY EXTENTION</b></td>
		</tr>
	  ...
	  <tr>
		<td colspan ='3' style="background-color:#3fb5b5;color:#FFF"><b>DELIVERY</b></td>
      </tr>
	   <!-- DELIVERY-->
		<tr>
