...
class SchedulerHandheldGraha extends CI_Controller
{
    ...
    public function kirim_graha_terbitSpk()
    {
            ...
            where DATE(T.WK_REQ) >= DATE_ADD(NOW(), interval - 15 day) and LG.no_spk is null and T.KD_STATUS IN('100','200','400', '500') and G.DISCHARGE is not null and YEAR(T.TGL_DOK) >= 2020 order by T.NO_SPK asc limit 7";
