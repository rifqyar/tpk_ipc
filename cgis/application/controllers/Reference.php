...
class Reference extends CI_Controller {
	...
	public function customer($act,$id){
		if (!$this->session->userdata('LOGGED')){
			...
			if($act=="add"){
				...
				$data['id'] = '';
				$data['action'] = 'save';
				echo $this->load->view('content/reference/customer_add',$data,true);
			}else if($act=="update"){
				//echo "string";die();
				//print_r($id);die();
				...
				$data['arrdata'] = $this->m_execute->get_data('customer', $id);
				...
				$arrdata = $this->m_reference->customer($act, $id);
	...
	public function hrlibur($act,$id){
		...
		$id = ($id!="")?$id:$this->input->post('id');
		if($act=="add"){
			$data['title'] = 'ENTRY HARI LIBUR';
			$data['id'] = '';
			$data['action'] = 'save';
			echo $this->load->view('content/reference/libur_add',$data,true);
		}else if($act=="update"){
			$this->load->model("m_reference");
			$data['title'] = 'UPDATE HARI LIBUR';
			$data['id'] = $id;
			$data['action'] = 'update';
			$data['arrdata'] = $this->m_reference->execute('get', 'libur', $id);
			echo $this->load->view('content/reference/libur_add',$data,true);
		}else{
			$this->load->model("m_reference");
			$arrdata = $this->m_reference->hrlibur($act, $id);
			$data = $this->load->view('content/newtable', $arrdata, true);
			if($this->input->post("ajax")||$act=="post"){
				echo $arrdata;
			}else{
	...
	public function alat($act,$id){
		...
		$id = ($id!="")?$id:$this->input->post('id');
		if($act=="add"){
			$data['title'] = 'ENTRY ALAT PEKERJAAN';
			$data['id'] = '';
			$data['action'] = 'save';
			echo $this->load->view('content/reference/alat_add',$data,true);
		}else if($act=="update"){
			$this->load->model("m_reference");
			$data['title'] = 'UPDATE ALAT PEKERJAAN';
			$data['id'] = $id;
			$data['action'] = 'update';
			$data['arrdata'] = $this->m_reference->execute('get', 'alat', $id);
			echo $this->load->view('content/reference/alat_add',$data,true);
		}else{
			$this->load->model("m_reference");
			$arrdata = $this->m_reference->alat($act, $id);
			$data = $this->load->view('content/newtable', $arrdata, true);
			if($this->input->post("ajax")||$act=="post"){
				echo $arrdata;
			}else{
	...
	public function truck($act,$id){
		...
		$id = ($id!="")?$id:$this->input->post('id');
		if($act=="add"){
			$data['title'] = 'ENTRY TRUCK';
			$data['id'] = '';
			$data['action'] = 'save';
			echo $this->load->view('content/reference/truck_add',$data,true);
		}else if($act=="update"){
			$this->load->model("m_reference");
			$data['title'] = 'UPDATE TRUCK';
			$data['id'] = $id;
			$data['action'] = 'update';
			$data['arrdata'] = $this->m_reference->execute('get', 'truck', $id);
			echo $this->load->view('content/reference/truck_add',$data,true);
		}else{
			$this->load->model("m_reference");
			$arrdata = $this->m_reference->truck($act, $id);
			$data = $this->load->view('content/newtable', $arrdata, true);
			if($this->input->post("ajax")||$act=="post"){
				echo $arrdata;
			}else{
	...
	public function mail($act,$id){
		...
		if($act=="add"){
			...
			$this->load->model("m_reference");
			$arrdata = $this->m_reference->mail($act, $id);
			$data = $this->load->view('content/newtable', $arrdata, true);
			if($this->input->post("ajax")||$act=="post"){
				echo $arrdata;
			}else{
	...
	public function user($act,$id){
		...
		if($act=="add"){
			...
			$data['id'] = '';
			$data['action'] = 'save';
			echo $this->load->view('content/reference/user_add',$data,true);
		}else if($act=="update"){
			//echo "string";die();
			//print_r($id);die();
			...
			$this->load->model("m_reference");
			$arrdata = $this->m_reference->user($act, $id);
			$data = $this->load->view('content/newtable', $arrdata, true);
			if($this->input->post("ajax")||$act=="post"){
				echo $arrdata;
			}else{
	...
	public function dokumenbc($act,$id){
		...
		if($act=="add"){
			$data['title'] = 'ENTRY DOKUMEN BEA CUKAI';
			$data['id'] = '';
			$data['action'] = 'save';
			echo $this->load->view('content/reference/bc_add',$data,true);
		}else if($act=="update"){
			$data['title'] = 'UPDATE DOKUMEN BEA CUKAI';
			$data['id'] = $id;
			$data['action'] = 'update';

			$this->load->model("m_execute");
			$data['arrdata'] = $this->m_execute->get_data('dokbc', $id);
			//var_dump($data);die();
			echo $this->load->view('content/reference/bc_add',$data,true);
		}else if($act=="delete"){
			// $data['title'] = 'DELETE DOKUMEN BEA CUKAI';
			// $data['id'] = $id;
			// $data['action'] = 'delete';
			// $this->load->model("m_execute");
			// $data['arrdata'] = $this->m_execute->get_data('dokbc', $id);
			...
			$this->load->model("m_reference");
			$arrdata = $this->m_reference->dokumenbc($act, $id);
			$data = $this->load->view('content/newtable', $arrdata, true);
			if($this->input->post("ajax")||$act=="post"){
				echo $arrdata;
			}else{
