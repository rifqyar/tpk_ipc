...
<div class="panel">
  <button type="submit"  class="btn btn-sm btn-info navbar-right navbar-btn waves-effect waves-light" onclick="save_post('form_da','divtblmnl'); return false;">
        ...
        <form name="form_da" id="form_da" class="form-horizontal" role="form" action="<?php echo site_url('execute/process/save/manual_karantina/'.$id); ?>" method="post" autocomplete="off" onsubmit="save_post('form_data','divtblmnl'); return false;" popup="1">
          <div class="panel-body container-fluid">
            <div class="row">
              ...
              <div class="form-group form-material">
				...
				<div class="col-sm-1">
                  <button type="button" class="btn btn-info btn-sm" onclick="popup_searchtwo('popup/popup_search/mt_customer/NPWP|NAMA_CUST|ALAMAT/2');"><span class="icon md-search"></span></button>
                </div>
              </div>
		  ...
		  <div class="panel-body container-fluid">
            ...
            <div class="col-md-12">
            	...
            	<center><button class="btn btn-sm btn-info" onclick="addcont2()" type="button"><i class="icon-plus"></i> ADD</button></center>
            </div>
            <div class="col-md-12">
            	<div>&nbsp;</div>
