...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo base_url(); ?>assets/template/compiled/svg/favicon.svg"
        type="image/x-icon">
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/template/compiled/css/app.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/template/compiled/css/app-dark.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/template/compiled/css/iconly.css">
...
<body>
    <script src="<?php echo base_url(); ?>assets/template/static/js/initTheme.js"></script>
    <div id="app">
        <div id="sidebar">
            <div class="sidebar-wrapper active">
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo">
                            <a href="<?php echo base_url(); ?>">BOS</a>
                        </div>
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item">
                            <a href="<?php echo base_url(); ?>application.php/PortalHelpdesk/delbildel"
                                class='sidebar-link'>
                                <i class="bi bi-grid-fill"></i>
                                <span>Hapus Status Billing Delivery</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a href="<?php echo base_url(); ?>application.php/PortalHelpdesk/delbilbhd"
                                class='sidebar-link'>
                                <i class="bi bi-grid-fill"></i>
                                <span>Hapus Status Billing Behandle</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a href="<?php echo base_url(); ?>application.php/PortalHelpdesk/updatewkinnpck"
                                class='sidebar-link'>
                                <i class="bi bi-egg-fill"></i>
                                <span>Update WK Pickup dan BehandleIN</span>
                            </a>
                        </li>
                         <li class="sidebar-item">
                            <a href="<?php echo base_url(); ?>application.php/PortalHelpdesk/clearing"
                                class='sidebar-link'>
                                <i class="bi bi-stack"></i>
                                <span>Cek Clearing Billing</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a href="<?php echo base_url(); ?>application.php/PortalHelpdesk/sendcustomdatamanual"
                                class='sidebar-link'>
...
<!--
                        ...
                        <li class="sidebar-item">
                            <a href="<?php echo base_url(); ?>application.php/PortalHelpdesk/doblrev"
                                class='sidebar-link'>
                                <i class="bi bi-hexagon-fill"></i>
                                <span>Revisi Dok Pabean</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a href="<?php echo base_url(); ?>application.php/PortalHelpdesk/doblrev"
                                ...
                                <span>Revisi Dok Karantina</span>
                            </a>
                        </li> -->
