              ...
              <table class="table">
                  ...
                  <tbody>
                      ...
                      <td>
                        ...
                        <td>
                          <select class="form-control" id="warna" name="warna"  required aria-required="true">
                            <option value="">Pilih Warna Segel</option>
                            <option value="N">Putih</option>
                            <option value="M" >Merah</option>
                            <option value="T">Timah</option>
                          </select>
                        </td>
                        <td>
