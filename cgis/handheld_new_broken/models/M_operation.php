...
class M_operation extends CI_Model{
	...
	public function new_set_marshalling_yard($idJobSlip,$nocont,$ukuran,$lokasiakhir,$job,$respon,$note,$jenisPekerjaan1,
				$alat1,
				$operator1,
				$penggunaan1,
				$jenisPekerjaan2,
