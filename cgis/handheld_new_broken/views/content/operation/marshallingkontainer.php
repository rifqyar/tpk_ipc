<?php
echo form_open('operation/search_kontainer');
?>
...
<div class="container">
    ...
    <br>
    <H5 style="color:white;">MARSHALLING KONTAINER</H5>
    <br>
    <div class="form_group form_material">
        ...
        <div class="col-sm-3" >
            ...
            <a href="<?php echo site_url('operation/marshallingkontainer') ?>" class="btn btn-danger" style="border: 1px solid #a1a1a1;">REFRESH</a>
        </div>
    </div>
</div>
                        ...
                        <div class="panel-body table-responsive">
                            <table class="table" class="table table-bordered table-hover">
                              ...
                              foreach ($nilai as $nilai2): 
                                echo form_open('operation/marshallingkontainer');
                            ...
                            <table class="table" class="table table-bordered table-hover">
                              ...
                              foreach ($nilai as $nilai2): 
                                ...
                                <tr>
                                    ...
                                    <td><H6 style="color:white;"><input type="text" class="form-control" id="respon" name="respon" value="<?php echo $RESPON; ?>" readonly ></H6></td>
                                    <td><H6 style="color:white;"> 
                                       <a href="<?php echo site_url('operation/detailmarshallings/'.$nilai2['ID_JOB_SLIP'].'') ?>"  style="text-decoration: none;" type="button" class="btn btn-primary">MARSHALLING</a>
