                ...
                <table class="table">
                  ...
                  <tbody>
                   <?php
					 ...
					 ?>
                     <tr>
					  <td><input type="hidden" class="form-control" id="nomerspk" name="nomerspk" value="<?php echo $nilai2['NO_SPK']; ?>" readonly ></td>
                      ...
                      <td>
                        <button id="str" type="submit"  class="btn btn-primary">ON CHASSSIS</button>
                      </td>
                    </tr>
                    <?php 
					echo form_close();
                  ...
                  <tbody>
                   <?php
                     ...
                     <tr>
                      ...
                      <td><input type="text" class="form-control" id="lokasi" name="lokasi" value="<?php echo $lok; ?>" readonly ></td>
                      <td>
                        <button id="str" type="submit"  class="btn btn-primary">ON CHASSIS</button>
                      </td>
                    </tr>
                    <?php 
					echo form_close();
