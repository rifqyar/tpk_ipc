            ...
            <div class="panel-body container-fluid">
              <div class="row">
                ...
                <div class="form-group form-material">
                  ...
                  <div class="col-sm-4">
                    <input type="text" name="DATA[KD_TPS_TUJUAN]" id="KD_TPS_TUJUAN" class="form-control" placeholder="KODE TPS TUJUAN" value="<?php echo $arrdata['KD_TPS_TUJUAN']; ?>">
                    <div class="hint">KODE TPS TUJUAN</div>
                  </div>
                </div>
                <div class="form-group form-material">
