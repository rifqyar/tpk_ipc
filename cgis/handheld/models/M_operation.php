...
class M_operation extends CI_Model{
	...
	// 	}
	// }
	public function new_set_marshalling_cic($idJobSlip,$nocont,$ukuran,$lokasiakhir,$job,$respon,$note,$fumigasi,
				$jenispekerjaan1,
				$alat1,
				$operator1,
				// $penggunaan1,
	...
	public function new_set_marshalling_yard($idJobSlip,$nocont,$ukuran,$lokasiakhir,$job,$respon,$note,$fumigasi,
				$jenispekerjaan1,
				$alat1,
				$operator1,
				// $penggunaan1,
    ...
    public function InsertDataMarshallingKontainer($idJobSlip,
				$nocont,
				$jenisPekerjaan1,
				$alat1,
				$operator1,
