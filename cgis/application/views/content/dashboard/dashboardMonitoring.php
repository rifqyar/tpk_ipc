		...
		<div>
			...
			<form action="<?php //echo site_url('/dashboard/dashMonitoring'); ?>" method="post">
				<div id="wrapper" align="center">
					...
					<input type="checkbox" name="selected" id="100" class="job" <?php //echo if(isset($this->input->post('selected')) echo "checked ='checked'"); ?>  value="100" /> <label for="box_1">SPK</label>
					...
					<input type="checkbox" name="selected" id="box_11" class="job" value="860" /> <label for="box_2">Dry</label>
					<input type="checkbox" name="selected" id="box_12" class="job" value="861" /> <label for="box_2">Rfr</label>
