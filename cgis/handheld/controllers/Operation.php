...
class Operation extends CI_Controller {
	...
	public function search_pickup_test(){
		...
		if (substr($keyword,1,3) != 'MTI') {
			$keyword    =  $this->input->post('search_spk');
			$keyword1    =  $this->input->post('search_spk');
		}else {
			$keyword    =  strtoupper(str_replace(' ', '',$this->input->post('search_spk')));
			$keyword1    =  strtoupper(str_replace(' ', '',$this->input->post('search_spk')));
		}
	...
	public function Insertmarshallingkontainer(){
		...
		if($statusspk == '460'){
			...
			$insert1= $this->M_operation->new_set_marshalling_yard($idJobSlip,$nocont,$ukuran,$lokasiakhir,$job,$respon,$note,$fumigasi,
				$jenispekerjaan1,
				$alat1,
				$operator1,
				// $penggunaan1,
