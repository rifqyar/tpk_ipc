...
class PortalDashboardDev extends CI_Controller
{
    ...
    public function requestdokumen()
    {
        ...
        if ($type != '') {
            ...
            // die();
            $this->db->query("INSERT INTO `tpk_ipc`.`solver_req_dokumen_log` (`url`, `tipe`, `no_dok`, `tgl_dok`, `npwp`, `data_respons`) VALUES ('https://api.npct1.co.id:9443/api/v1/get-customs-ondemand', 'sppb', '$no_dok', '$tgl_dok', '$npwp', '$responget')");
            ...
            $TGL_DOK_INOUT = $this->gantiformattglnpct($xml->DOCUMENT->MANUAL->HEADER->TGL_DOK_INOUT); 
            ...
            $TGL_BC11 = $this->gantiformattglnpct($xml->DOCUMENT->MANUAL->HEADER->TGL_BC11); 
            $NO_POS_BC11 = $xml->DOCUMENT->MANUAL->HEADER->NO_POS_BC11; 
            $NO_BL_AWB = $xml->DOCUMENT->MANUAL->HEADER->NO_BL_AWB; 
            $TG_BL_AWB = $this->gantiformattglnpct($xml->DOCUMENT->MANUAL->HEADER->TG_BL_AWB); 
            ...
            $this->db->query("INSERT INTO `tpk_ipc`.`solver_req_dokumen_log` (`url`, `tipe`, `no_dok`, `tgl_dok`, `npwp`, `data_respons`) VALUES ('https://api.npct1.co.id:9443/api/v1/get-customs-ondemand', '$type', '$no_dok', '$tgl_dok', '$npwp', '$responget')");
    ...
    if (strpos($response, 'Data tidak ditemukan') !== false) {
        ...
        $this->db->query("INSERT INTO `tpk_ipc`.`solver_req_dokumen_log` (`url`, `tipe`, `no_dok`, `tgl_dok`, `npwp`, `data_respons`) VALUES ('https://api.npct1.co.id:9443/api/v1/get-customs-ondemand', 'npe', '$no_dok', '$tgl_dok', '$npwp', '$responget')");
