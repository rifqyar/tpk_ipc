...
<div class="panel">
  ...
  <button type="submit" class="btn btn-sm btn-info navbar-right navbar-btn waves-effect waves-light" onclick="save_post('form_data','divtblbehandle'); return false;">
  ...
  <div class="panel-body container-fluid">
    ...
    <div class="row">
      <div class="col-sm-12">
        <form name="form_data" id="form_data" class="form-horizontal" role="form" action="<?php echo site_url('billingBehandle/process/confirm_behandle/'); ?>" method="post" autocomplete="off" onsubmit="save_post('form_data','divtblbehandle'); return false;" popup="1">
          <div class="panel-body container-fluid">
            <div class="row">
