...
<head>
    ...
    <link rel="shortcut icon" href="../../../../assets/template/compiled/svg/favicon.svg" type="image/x-icon">
  ...
  <link rel="stylesheet" href="../../../../assets/template/compiled/css/app.css">
  <link rel="stylesheet" href="../../../../assets/template/compiled/css/app-dark.css">
  <link rel="stylesheet" href="../../../../assets/template/compiled/css/iconly.css">
</head>

<body>
    <script src="../../../../assets/template/static/js/initTheme.js"></script>
    <div id="app">
        <div id="sidebar">
    ...
    <div class="sidebar-header position-relative">
        <div class="d-flex justify-content-between align-items-center">
            <div class="logo">
                <a href="index.html"><img src="../../../../assets/template/compiled/svg/logo.svg" alt="Logo" srcset=""></a>
            </div>
...
<div class="page-content"> 
                                ...
                                <div class="col-7">
                                    <div class="d-flex align-items-center">
                                        <svg class="bi text-primary" width="32" height="32" fill="blue"
                                            style="width:10px">
                                            <use
                                                xlink:href="../../../../assets/template/static/images/bootstrap-icons.svg#circle-fill" />
                                        </svg>
                                    ...
                                    <tbody>
                                            ...
                                            <td class="col-3">
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-md">
                                                        <img src="../../../../assets/template/compiled/jpg/5.jpg">
                                                    </div>
                                        ...
                                        <tr>
                                            <td class="col-3">
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-md">
                                                        <img src="../../../../assets/template/compiled/jpg/2.jpg">
                                                    </div>
                                        ...
                                        <tr>
                                            <td class="col-3">
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-md">
                                                        <img src="../../../../assets/template/compiled/jpg/8.jpg">
                                                    </div>
                                        ...
                                        <tr>
                                            <td class="col-3">
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-md">
                                                        <img src="../../../../assets/template/compiled/jpg/3.jpg">
                                                    </div>
                ...
                <div class="card-body py-4 px-4">
                    <div class="d-flex align-items-center">
                        <div class="avatar avatar-xl">
                            <img src="../../../../assets/template/compiled/jpg/1.jpg" alt="Face 1">
                        </div>
                        <div class="ms-3 name">
                ...
                <div class="card-content pb-4">
                    <div class="recent-message d-flex px-4 py-3">
                        <div class="avatar avatar-lg">
                            <img src="../../../../assets/template/compiled/jpg/4.jpg">
                        </div>
                        <div class="name ms-4">
                    ...
                    <div class="recent-message d-flex px-4 py-3">
                        <div class="avatar avatar-lg">
                            <img src="../../../../assets/template/compiled/jpg/1.jpg">
                        </div>
                        <div class="name ms-4">
    ...
    <script src="../../../../assets/template/static/js/components/dark.js"></script>
    <script src="../../../../assets/template/extensions/perfect-scrollbar/perfect-scrollbar.min.js"></script>
    
    
    <script src="../../../../assets/template/compiled/js/app.js"></script>
    

    
<!-- Need: Apexcharts -->
<script src="../../../../assets/template/extensions/apexcharts/apexcharts.min.js"></script>
<script src="../../../../assets/template/static/js/pages/dashboard.js"></script>
