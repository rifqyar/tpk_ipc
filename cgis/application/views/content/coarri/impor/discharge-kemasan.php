    ...
    <div class="row">
      <div class="col-sm-12">
        <form name="form_kms" id="form_kms" class="form-horizontal" role="form" action="<?php echo site_url('execute/process/'.$action.'/kemasan_in/'.$id); ?>" method="post" autocomplete="off" onsubmit="save_post('form_kms','divtblkemasan'); return false;" popup="1">
          <div class="panel-body container-fluid">
            <div class="row">
              <div class="form-group form-material">
                ...
                <div class="col-sm-1">
                  <button type="button" class="btn btn-sm btn-primary" onclick="popup_searchtwo('popup/popup_search/discharge_kontainer|<?php echo $id; ?>/ID_CONT_ASAL|NO_CONT_ASAL/2'); ">
          ...
          <input type="hidden" name="action" id="action" value="<?php echo site_url('coarri/discharge_kemasan/post/'.$post); ?>" readonly="readonly"/>
        </form>
      </div>
    </div>
  </div>
