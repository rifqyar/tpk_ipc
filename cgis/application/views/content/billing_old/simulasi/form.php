...
<div class="panel">
  <div class="ribbon ribbon-clip ribbon-primary">
  	<span class="ribbon-inner">
		<i class="icon md-file-text margin-0" aria-hidden="true"></i> Simulasi<?php //echo $title; ?>
    </span>
  </div>
  ...
  <button type="button" class="btn btn-sm btn-primary navbar-right navbar-btn waves-effect waves-light" onclick="popup_searchtwo('popup/popup_search/mt_dok_sppb/NM_KAPAL|VOYAGE|NO_DOK|TGL_DOK_INOUT/2');"><span class="icon md-search"></span>Cari Dokumen</button>
  <BR><BR>
  <div class="panel-body container-fluid">
    <div class="row">
      <div class="col-sm-12">
        <form name="form_data" id="form_data" class="form-horizontal" role="form" action="<?php echo site_url('execute/process/'.$action.'/simulasi/'.$id); ?>" method="post" autocomplete="off" onsubmit="save_post('form_data','divtblsimulasi'); return false;" popup="1">
          <div class="panel-body container-fluid">
            <div class="row">
              ...
              <div class="form-group form-material">
                ...
                <div class="col-sm-9">
                  <input type="text" name="DATA[VOYAGE]" id="VOYAGE" mandatory="no" class="form-control" placeholder="VOYAGE" value="<?php echo $arrdata[0]->NO_VOY_FLIGHT; ?>" maxlength="10">
              ...
              <div class="form-group form-material">
                ...
                <div class="col-sm-9">
                  <input type="text" name="DATA[NO_DO]" id="CONTACT_PERSON" mandatory="no" class="form-control" placeholder="NO. DO" value="<?php //echo $arrdata['CONTACT_PERSON']; ?>" maxlength="10">
              ...
              <div class="form-group form-material">
                ...
                <div class="col-sm-9">
                  <input type="text" name="DATA[TGL_DOK_INOUT]" id="TGL_DOK_INOUT" readonly="readonly" mandatory="no" class="form-control" placeholder="TGL. DOKUMEN" value="<?php echo date('d-m-Y', strtotime($arrdata[0]->TGL_DOK_INOUT)); ?>" maxlength="10">
              ...
              <div class="form-group form-material">
                ...
                <div class="col-sm-9">
                  <input type="text" name="DATA[NO_DOK]" id="NO_DOK" mandatory="no" class="form-control" placeholder="NO_DOK" value="<?php echo $arrdata[0]->NO_DOK_INOUT; ?>" maxlength="10">
      ...
      <br><Br><br><Br>
        ...
        <tr>
          ...
          <input type="hidden" name="action" id="action" readonly="readonly" value="<?php echo site_url('customer/simulasi_billing/post'); ?>"/>
          <input type="hidden" name="cont_post" id="cont_post" readonly="readonly" mandatory="yes">
        </form>
		<button type="submit" class="btn btn-sm btn-primary navbar-center navbar-btn waves-effect waves-light" onclick="save_post('form_data','divtblsimulasi'); return false;">
		<i class="icon md-badge-check"></i> SAVE
	  </button>
      </div>
    </div>
