<div class="panel">
    <button type="submit" class="btn btn-sm btn-primary navbar-right navbar-btn waves-effect waves-light"
        ...
        <i class="icon md-badge-check"></i> TOLAK
    </button>
    <div class="panel-body container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <form name="form_data" id="form_data" class="form-horizontal" role="form"
                    action="<?php echo 'online/prosesonlineetolak?id='.$arrdata->ID; ?>" method="post" autocomplete="off"
                    ...
                    <input type="hidden" name="action" id="action" readonly="readonly"
                        value="<?php echo site_url('online/prosesonlineetolak'); ?>" />
                    <div class="panel-body container-fluid">
                        <div class="row">
                            <div class="form-group form-material">
                                ...
                                <input type="hidden" name="FL_STATUS" value="<?php echo $arrdata->FL_STATUS;?>">
                                <input type="hidden" name="ID_BEHANDLE2" value="<?php echo $arrdata->ID_BEHANDLE2;?>">
                            </div>
                        </div>
                    </div>
            </form>
