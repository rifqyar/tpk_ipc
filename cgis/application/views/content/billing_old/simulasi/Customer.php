...
class Customer extends CI_Controller {
	...
	public function simulasi_billing(){
		if (!$this->session->userdata('LOGGED')){
			$this->index();
			return;
		}
		...
		if($act=="add"){
			...
			$data['arrdata'] = $this->m_execute->get_data_dokumen('sppb_bill', $id);
			//print_r($data);die();
			...
			/*$data = $this->load->view('content/billing/simulasi/form', $arrdata, true);
			if($this->input->post("ajax")||$act=="post"){
				echo $arrdata;
			}else{
				$this->content = $data;
