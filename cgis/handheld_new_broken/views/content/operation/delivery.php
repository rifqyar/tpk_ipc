  ...
  <br>
	<H5 style="color:white;">DELIVERY</H5><br>
         ...
         <div class="container">
           <div class="col-md-4 form-group">
                 ...
                 <input type="text" class="form-control col-md-4 col-sm-4" id="ukuran" name="ukuran" value="<?php echo $ukurane; ?>" readonly><br><br><br>
                  <br><label style="color:white;" for="No_cont">NO TRUCK</label>
                 <input type="text" class="form-control col-md-4 col-sm-4" id="Nomtr" name="nomertruck" required ><br><br><br>
				  <br><label style="color:white;" for="kond" >GATE</label>
					<div class="row">
						<div class=" col-md-12">
                 ...
                 <br><br>
                 <button type="submit" style=" width:150px; border: 2px solid #a1a1a1; height: 35px" class="btn btn-primary" >TRUCK IN</button>
           </div>
        </div>
<?php }elseif ($status==2) { 
echo form_open('operation/delivery');
?>
    <div class="container">
        <div class="col-md-4 form-group">
              ...
              <label style="color:white;" for="kond" >GATE</label>
              <div class="row">
                <div class=" col-md-12">
                  <select class="form-control" id="gate" name="gate">
                      <option value="GATE 1">GATE 1</option>
                 ...
                 <button style=" width:150px; border-radius:5px; border: 1px solid #a1a1a1; height: 35px" id="str" type="submit"  class="btn btn-primary">GATE OUT</button>  
        </div>                   
     </div>
    <?php echo form_close(); ?>
 <?php }else { ?>
