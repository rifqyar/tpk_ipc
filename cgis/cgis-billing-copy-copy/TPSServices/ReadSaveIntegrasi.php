            ...
            while ($Query->next()) {
                ...
                if ($length > 1) {
                    for ($c = 0; $c < $length; $c++) {
                        ...
                        $SQL = "UPDATE req_delivery_hdr SET FL_SEND_TRANS_SIMKEU = '" . $status . "' WHERE NO_NOTA_DELIVERY = '" . $transaction_number . "'";
                        echo $SQL . "<br>";
                        ...
                        $SQL = "UPDATE req_delivery_hdr SET FL_SEND_RECEIPT_SIMKEU = '" . $status . "' WHERE NO_NOTA_DELIVERY = '" . $receipt_number . "'";
                        echo $SQL . "<br>";
                        $Execute = $conn->execute($SQL);
