                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h4 class="card-title">Get SPPB On Demand</h4>
                                        </div>
                                        <div class="card-body">
                                            <form action="<?php echo base_url();?>application.php/PortalDashboard/requestdokumen" method="POST">
                                            <input type="hidden" name="type" value="sppbnew">
                                            ...
                                            <div class="form-group form-inline">
                                                ...
                                                <div class="col-md-10 p-0">
                                                    <input
                                                        ...
                                                        id="inlineinput"
                                                        name="tgldok"
                                                        placeholder="Isi Tanpa Simbol" required>
                                                </div>
                                            </div>
                                            <div class="form-group form-inline">
                                                <label for="inlineinput" class="col-md-2 col-form-label">*NPWP Importir</label>
                                                <div class="col-md-10 p-0">
                                                    <input
                                                        type="text"
                                                        class="form-control input-full"
                                            ...
                                            <table class="table table-head-bg-primary mt-4">
                                                ...
                                                foreach ($log_data as $key => $value) {
                                                    ...
                                                    if ($value->NO_DOK_INOUT != "") {
                                                        echo "<td style='color: green;'><b>Dokumen Tersedia</b></td>";
                                                    } else {
                                                        echo "<td style='color: red;'><b>Dokumen Belum Tersedia</b></td>";
                                                    }
                                                echo "</tr>";
                                                }
                                            ?>
