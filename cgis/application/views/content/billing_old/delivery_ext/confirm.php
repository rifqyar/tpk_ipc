...
<div class="panel">
  ...
  <button type="submit" class="btn btn-sm btn-primary navbar-right navbar-btn waves-effect waves-light" onclick="save_post('form_data','divtbldeliveryext'); return false;">
  ...
  <div class="panel-body container-fluid">
    ...
    <div class="row">
      <div class="col-sm-12">
        <form name="form_data" id="form_data" class="form-horizontal" role="form" action="<?php echo site_url('execute/process/save/confirm_ext/'); ?>" method="post" autocomplete="off" onsubmit="save_post('form_data','divtblbehandle'); return false;" popup="1">
          <div class="panel-body container-fluid">
            <div class="row">
          ...
          <input type="hidden" name="action" id="action" readonly="readonly" value="<?php echo site_url('billing/delivery_ext/post'); ?>"/>
        </form>
      </div>
    </div>
  </div>
