                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h4 class="card-title">Ondemand insw dokumen sppmp</h4>
                                        </div>
                                        <div class="card-body">
                                            <form
                                                action="<?php echo base_url();?>application.php/PortalDashboard/requestinsw"
                                                method="POST">
                                                <div class="form-group form-inline">
                                                    <label for="inlineinput" class="col-md-3 col-form-label">NOMOR Pengajuan </label>
                                                    <div class="col-md-9 p-0">
                                                        <input
                                                            ...
                                                            id="inlineinput"
                                                            name="noaju"
                                                            placeholder="Nomor yang tertera di dokumen PIB. Contoh 2012028A2B9620241010000005"
                                                            required="required">
                                                    </div>
                                                </div>
