...
<div class="panel">
  ...
  <div class="panel-body container-fluid">
    <div class="row">
      <div class="col-sm-12">
        <form name="form_data" id="form_data" class="form-horizontal" role="form" action="<?php echo site_url('billingBehandle/process/update_behandle2/'.$id); ?>" method="post" autocomplete="off" onsubmit="save_post('form_data','tblbehandle'); return false;" popup="1">
          <div class="panel-body container-fluid">
            <div class="row">
              ...
              <div class="form-group form-material">
                ...
                <div class="col-sm-9">
                  <input type="text" name="DATA[JNS_DOK]" id="JNS_DOK" mandatory="no" class="form-control" placeholder="JENIS DOKUMEN" value="<?php echo $arrdata[0]['JNS_DOK']; ?>" maxlength="50" >
              ...
              <div class="form-group form-material">
                ...
                <div class="col-sm-9">
                  <input type="text" name="DATA[NO_DOK]" id="ADDRESS" mandatory="no" class="form-control" placeholder="NO DOKUMEN" value="<?php echo $arrdata[0]['NO_DOK']; ?>" maxlength="50" >
              ...
              <div class="form-group form-material">
                ...
                <div class="col-sm-9">
                  <input type="text" name="DATA[PAKET]" id="ADDRESS" mandatory="no" class="form-control" placeholder="PAKET BEHANDLE" value="<?php echo $arrdata[0]['JNS_KEGIATAN']; ?>" maxlength="50" >
