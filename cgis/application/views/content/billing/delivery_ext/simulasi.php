		...
		　　　　          		N.P.W.P.	: 03.276.307.0-093.000
				...
				<tr>
					...
					<?php
						if ($result_hdr[0]["NO_NOTA_DELIVERY"] == NULL) {
							echo "PRANOTA DELIVERY EXT";
						} else {
							echo "NOTA DELIVERY EXT";
						}
					?> 
						</b>
					</font></td>
               ...
               <tr height="30">
				...
				<tr>
					...
					<td colspan="3"></td>
					<td colspan="12" align="left">Date Of Stacking : <?php echo  $result[0]['START']?></td>
				</tr> 
				<tr>
					<td colspan="3"></td>
					...
					if($result[$c]['JUMLAH'] > 0){
						echo $tr = '
								<tr>
									...
									<td colspan>'.date('d-m-Y', strtotime($result[$c]['END'])).'</td>
									<td align="center">'.$result[$c]['UKURAN CONT'].'</td>
