        ...
        <form class="form-horizontal" id="modalPopup" action="" method="post" role="form">
          <div class="form-group">
            ...
            <div class="form-group">
			  ...
			  <input type="hidden" name="lokasi_awal" id="lok_awal" value="<?php echo $arrdata['LOKASI_AWAL']; ?>">
...
<script>
	...
	$("#addContPlanJob").click(function(){
		...
		$.ajax({
			...
			data: { KODE_GDG:KODE_GDG, BLOK:BLOK, LOK_AKHIR:LOK_AKHIR, NO_CONT:NO_CONT, PENUMPUKAN:PENUMPUKAN, X:X, Y:Y, NO_SPK:NO_SPK, no_dok:no_dok, jns_kegiatan23:jns_kegiatan, lokasi_awal:lokasi_awal,ID_JOB:ID_JOB },
		...
		setTimeout(function () {
			...
			//var URL = '<?php echo site_url();?>/planning/placement';
