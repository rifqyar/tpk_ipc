...
<div class="container-fluid">
        <div class="row">
            <div class="col-md-offset-1 col-md-10">
                    ...
                    <a href="<?php echo site_url('operation/opr'); ?>"><H4 style="color:white;"><< MENU HANDHELD</H4></a><br><br>
            ...
            <div class="modal-body">
                <div class=" col-md-12 form-group">
                    <div class="row">
                        <div class="col-md-offset-1 col-md-10">
                        <?php
                            echo form_open('operation/reportDetail');
                        ?>
                                <div class="form_group form_material">
                                    <div class="col-sm-4" >
                                        <input type="date" class="form-control" id="start_date" name="start_date"><!-- autofocus required> -->
   ...
   <script>
            ...
            var table = $('#data_table').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    "url": "<?php echo site_url('operation/getrange2') ?>",
                    "type": "POST",
                    "data": function(d) {
                ...
                "columns": [
                    ...
                    {"data": "pre_liftof", "searchable": true},
                    {"data": "pre_storage", "searchable": true},
                    {"data": "pre_lifton", "searchable": true},
                    {"data": "cic_striping", "searchable": true},
                    {"data": "cic_lifton", "searchable": true},
                    {"data": "post_haulage", "searchable": true},
                    {"data": "post_haulage", "searchable": true},
                    {"data": "post_liftoff", "searchable": true},
                    {"data": "post_storage", "searchable": true}
                    // ...tambahkan kolom lainnya
                ],
      
                "pageLength": 100, // Menampilkan 10 baris per halaman
