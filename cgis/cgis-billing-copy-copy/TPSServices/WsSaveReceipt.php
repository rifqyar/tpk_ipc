...
if (!$CheckFile) {
    ...
    if (date('H') >= $jam_awal && date('H') <= $jam_akhir) {
        $SQL = "SELECT DISTINCT A.ID AS ID, A.ID_REQ AS NO_ORDER, A.NO_NOTA_DELIVERY AS NO_INVOICE, A.ID_REQ_OLD AS EX_NOTA, C.NAMA_BANK AS BANK,
                ...
                /*WHERE A.NO_NOTA_DELIVERY IN ('030.801.18-61.010462','030.801.18-61.008444','030.801.18-61.008472','010.801.18-61.009402','010.801.18-61.009536','030.801.18-61.009916')
                ...
                */
                WHERE A.NO_NOTA_DELIVERY IN ('030.801.18-61.012247', '030.801.18-61.012262', '030.801.18-61.012240')            
            ...
            while ($Query->next()) {
                ...
                if ($Query2->size() > 0) {
                    ...
                    while ($Query2->next()) {
                        ...
                        } else if ($data2['JENIS_TARIF'] == 'DENDA SPPB') {
