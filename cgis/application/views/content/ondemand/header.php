            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo">
                            <a href="<?php echo base_url(); ?>">Helpdesk Mandiri</a>
                        </div>
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item">
                            <a href="<?php echo base_url(); ?>application.php/Ondemand/spjm"
                                class='sidebar-link'>
                        ...
                        <li class="sidebar-item">
                            <a href="<?php echo base_url(); ?>application.php/Ondemand/sppb"
                                class='sidebar-link'>
                        ...
                        <li class="sidebar-item">
                            <a href="<?php echo base_url(); ?>application.php/Ondemand/manual"
                                class='sidebar-link'>
                                <i class="bi bi-stack"></i>
                                <span>Dokumeen Manual</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a href="<?php echo base_url(); ?>application.php/Ondemand/npe"
                                class='sidebar-link'>
                                <i class="bi bi-stack"></i>
                                <span>NPE</span>
                            </a>
                        ...
                        <li class="sidebar-item">
                            <a href="<?php echo base_url(); ?>application.php/Ondemand/karantina"
                                class='sidebar-link'>
                                <i class="bi bi-stack"></i>
                                <span>Karantina</span>
                            </a>
