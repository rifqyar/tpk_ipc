  ...
  <div class="panel-body container-fluid">
    <div class="row">
      <div class="col-sm-12">
        ...
        -->
              <div class="form-group form-material">
                ...
                <div class="col-sm-9">
                  <input type="text" name="DATA[NM_KAPAL]" id="NO_DOK" mandatory="no" class="form-control" placeholder="NAMA KAPAL" value="<?php echo $arrdata[0]->NM_KAPAL; ?>" maxlength="10">
              ...
              <div class="form-group form-material">
                ...
                <div class="col-sm-9">
                  <input type="text" name="DATA[VOYAGE]" id="NO_DOK" mandatory="no" class="form-control" placeholder="VOYAGE" value="<?php echo $arrdata[0]->NO_VOY; ?>" maxlength="10">
              ...
              <div class="form-group form-material">
                ...
                <div class="col-sm-9">
                  <input type="text" name="DATA[NO_DOK]" id="NO_DOK" mandatory="no" class="form-control" placeholder="NO_DOK" value="<?php echo $arrdata[0]->NO_DOK; ?>" maxlength="10">
              ...
              <div class="form-group form-material">
                ...
                <div class="col-sm-9">
                  <input type="text" name="DATA[PAIDTHRU]" id="ATD" mandatory="yes" class="form-control datetime" placeholder="PAIDTHRU" value="<?php //echo $arrdata['ATD']; ?>" maxlength="10">
      ...
      <br><Br><br><Br>
        <table class="table">
                <th>
                  <input type="checkbox" class="chk_boxes" label="check all"  />All
                </th>
                <th>NO KONTAINER</th>
                <th>SIZE</th>
                <th>TYPE</th>
