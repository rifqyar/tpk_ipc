<?php
  echo form_open('operation/searchcopy');
?>
<div class="container">
<a href="<?php echo site_url('operation/opr'); ?>">
  ...
  <br>
	<H5 style="color:white;">COPYYARD</H5><br>
...
<div class="container">
      <?php if (isset($notif)): ?>
        <?php switch ($notif) {
		 ...
		 case 4:
           ...
           <br>
           <div class= 'alert alert-danger' style='font-size:16px; font-family:sant-serif; font-weight:bold; ' >
              LOKASI SUDAH DIGUNAKAN OLEH KONTAINER : $NOCONT
           </div>";
           break; 
		 case 5:
           echo "
    ...
    case 7:
           ...
           <br>
           <div class= 'alert alert-danger' style='font-size:16px; font-family:sant-serif; font-weight:bold; ' >
               KONTAINER : $NOCONT TIDAK DAPAT DIPINDAHKAN KE LOKASI $VARA KE LOKASI $VARB
           </div>";
           break;   
		case 8:
           echo "
           <br>
           <div class= 'alert alert-danger' style='font-size:16px; font-family:sant-serif; font-weight:bold; ' >
               KONTAINER : $NOCONT TIDAK DAPAT DIPINDAHKAN KARENA STATUS : $CONTSTATUS
           </div>";
           break;		   
          default:
            echo "
  ...
  echo form_close();
     ...
     echo form_open('operation/copyard');
  ?>
      <div class="container">
        <div class=" col-md-4 form-group">
              <label for="No_cont" style="color:white;">NO CONT</label>
              <div class="row">
                <div class=" col-md-12">
			  ...
			  <label for="ukr_cont" style="color:white;">UKURAN CONT</label>
              <div class="row">
                <div class=" col-md-12">
			  ...
			  <label for="jns_dok" style="color:white;">JENIS DOKUMEN</label>
              <div class="row">
                <div class=" col-md-12">
			  ...
			  <label for="status_cont" style="color:white;">STATUS CONT</label>
              <div class="row">
                <div class=" col-md-12">
              ...
              <label for="nolok" style="color:white;">LOKASI</label>
              <div class="row">
                <div class=" col-md-12">
			  ...
			  <?php
					...
					{
				?>
			  <br><label for="lokbar" style="color:white;" >ACTION BLOK</label>
              <div class="row">
                <div class=" col-md-12">
			  ...
			  <br><label for="lokbar" style="color:white;">LOKASI BARU</label>
              <div class="row">
                <div class=" col-md-12">
    ...
    <?php if (isset($kode)): ?>
      <?php switch ($kode) {
        case 1:
          ...
          echo "<br>
          <div class= 'alert alert-danger' style='font-size:16px; font-family:sant-serif; font-weight:bold; ' >
             WARNING ! NO CONT : $nilai TIDAK DAPAT DIPINDAHKAN KARENA STATUS PICKUP
          </div>";
          break;
        default:
          echo "";
