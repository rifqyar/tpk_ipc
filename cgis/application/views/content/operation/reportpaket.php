...
<html>
<body>
<h2 class="page-title" align="center">REPORT DETAIL PAKET</h2>
<br>
<div class="container-fluid">
                        ...
                        <table id="data_table" class="display" style="width:100%">
                            <thead>
                                <tr style="background-color:#3f51b5;">
                                    ...
                                    <th><H6 style="color:white;">No Document</H6></th>
                                    <th><H6 style="color:white;">Tanggal SPK</H6></th>
                                    ...
                                    <th><H6 style="color:white;">Paket 1</H6></th>
                                    <th><H6 style="color:white;">Paket 2</H6></th>
                                    <th><H6 style="color:white;">Paket 3</H6></th>
                                    <th><H6 style="color:white;">Paket 4</H6></th>
                                    <th><H6 style="color:white;">Paket 5</H6></th>
                                    <th><H6 style="color:white;">Paket 6</H6></th>
                                    <th><H6 style="color:white;">Paket 7</H6></th>
                                    <th><H6 style="color:white;">Paket 8</H6></th>
                                    <th><H6 style="color:white;">Paket 9</H6></th>
                                </tr>
                            </thead>
                            <tbody></tbody>
                             <tfoot>
            ...
            <div class="modal-body">
                <div class=" col-md-12 form-group">
                    <div class="row">
                        <div class="col-md-offset-1 col-md-10">
                        <?php
                            echo form_open('Report/reportPaket');
                        ?>
                                <div class="form_group form_material">
                                    <div class="col-sm-4" >
                                        <input type="date" class="form-control" id="start_date" name="start_date"><!-- autofocus required> -->
   ...
   <script>
            ...
            var table = $('#data_table').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    "url": "<?php echo site_url('Report/get_data_paket_bydate_range2') ?>",
                    "type": "POST",
                    "data": function(d) {
                ...
                "columns": [
                    ...
                    {"data": "NO_DOC", "searchable": true},
                    {"data": "TGL_SPK", "searchable": true},
                    {"data": "NO_CONT", "searchable": true},
                    // {"data": "UKR_CONT", "searchable": true},
                    // {"data": "TYPE_CONT", "searchable": true},
                    {"data": "PAKET1", "searchable": true},
                    {"data": "PAKET2", "searchable": true},
                    {"data": "PAKET3", "searchable": true},
                    {"data": "PAKET4", "searchable": true},
                    {"data": "PAKET5", "searchable": true},
                    {"data": "PAKET6", "searchable": true},
                    {"data": "PAKET7", "searchable": true},
                    {"data": "PAKET8", "searchable": true},
                    {"data": "PAKET9", "searchable": true}
            ...
            $( api.column( 5 ).footer() ).html(monTotal5);
            $( api.column( 6 ).footer() ).html(monTotal6);
            $( api.column( 7 ).footer() ).html(monTotal7);
            $( api.column( 8 ).footer() ).html(monTotal8);
            $( api.column( 9 ).footer() ).html(monTotal9);
            $( api.column( 10 ).footer() ).html(monTotal10);
            $( api.column( 11 ).footer() ).html(monTotal11);
            $( api.column( 12 ).footer() ).html(monTotal12);
            $( api.column( 13 ).footer() ).html(monTotal13);
            // $( api.column( 14 ).footer() ).html(monTotal14);
            // $( api.column( 15 ).footer() ).html(monTotal15);
        },
      
                "pageLength": 50, // Menampilkan 10 baris per halaman
                "lengthMenu": [50,150,200,500,1000], // Pilihan jumlah baris per halaman
                ...
                "order": [
                    [1, 'asc'] // Kolom pertama diurutkan berdasarkan ascending
                ],
