...
class Apibos extends CI_Controller {
	...
	public function billingdelivery()
    {
        ...
        try {
            ...
            if (!$ceksppb) {
                //$ceksppbon = $this->ondimendsppb($no_dok,$tgdok);
                //if (!$ceksppbon) {
                    return $this->httpres(200, 'error', '', 'Dokumen Tidak Di temukan atau Dokumen Sppb Belum keluar dari tps bea cukai , Silahkan Hubungi Bea Cukai');
                //}
            }
