<?php
  echo form_open('operation/srcyard');
?>
<div class="container">
  <div class="form_group form_material">
    ...
    <div class="col-sm-3" >
	  ...
	  <a href="<?php echo site_url('operation/marshallingyard') ?>" class="btn btn-danger" style="border-radius:10px; border: 2px solid #a1a1a1;">Refresh</a>
    </div>
  </div>
</div>
