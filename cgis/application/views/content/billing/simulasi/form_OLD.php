          ...
          <div class="panel-body container-fluid">
            <div class="row">
              ...
              <div class="form-group form-material">
                ...
                <div class="col-sm-9">
                  <input type="text" name="DATA[TGL_DOK_INOUT]" id="TGL_DOK_INOUT" readonly="readonly" mandatory="no" class="form-control" placeholder="TGL. DOKUMEN" value="<?php //echo $arrdata[0]->TGL_DOK_INOUT; ?>" maxlength="10">
              ...
              <div class="form-group form-material">
                ...
                <div class="col-sm-1">
                  <button type="button" class="btn btn-primary btn-sm" onclick="popup_searchtwo('popup/popup_search/mt_dok_sppb/NM_KAPAL|VOYAGE|NO_DOK|TGL_DOK_INOUT/2');"><span class="icon md-search"></span></button>
                </div>
              </div>
              <div class="form-group form-material">
