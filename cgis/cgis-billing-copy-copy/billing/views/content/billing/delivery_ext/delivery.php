...
<div class="panel">
  ...
  <div class="panel-body container-fluid">
    <div class="row">
      <div class="col-sm-12">
        <form name="form_data" id="form_data" class="form-horizontal" role="form" action="<?php echo site_url('billingDeliveryExt/process/'.$action.'/'.$id); ?>" method="post" autocomplete="off" onsubmit="save_post('form_data','tblbehandle'); return false;" popup="1">
          <div class="panel-body container-fluid">
            <div class="row">
              ...
              <div class="form-group form-material">
                ...
                <div class="col-sm-9">
                  <input type="text" name="DATA[TGL_DOK]" id="CONTACT_PERSON" mandatory="yes" class="form-control" placeholder="TANGGAL DOKUMEN" value="<?php echo $arrdata[0]['TGL_DOK']; ?>" maxlength="10">
              ...
              <div class="form-group form-material">
                ...
                <div class="col-sm-9">
                  <input type="text" name="DATA[EXPIRED]" id="CONTACT_PERSON" mandatory="no" class="form-control" placeholder="PAIDHTRU" value="<?php echo $arrdata[0]['EXPIRED']; ?>" maxlength="10" readonly>
                  <div class="hint">PAIDTHRU</div>
                </div>
              </div>
            </div>
          </div>
          <input type="hidden" name="action" id="action" readonly="readonly" value="<?php echo site_url('billingDeliveryExt/delivery_ext/post'); ?>"/>
        </form>
