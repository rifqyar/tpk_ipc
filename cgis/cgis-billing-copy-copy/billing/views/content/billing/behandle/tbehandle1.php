          ...
          <div class="panel-body container-fluid">
            <div class="row">
              ...
              <div class="form-group form-material">
                ...
                <div class="col-sm-9">
                  <input type="text" name="DATA[NO_DOK]" id="CONTACT_PERSON" mandatory="no" class="form-control" placeholder="NO. DOKUMEN" value="<?php echo $arrdata[0]->NO_DAFTAR_PABEAN; ?>" maxlength="10" readonly>
              ...
              <div class="form-group form-material">
                ...
                <div class="col-sm-9">
                  <input type="text" name="DATA[TGL_DOK]" id="CONTACT_PERSON" mandatory="no" class="form-control" placeholder="TGL. DOKUMEN" value="<?php echo $arrdata[0]->TGL_DAFTAR_PABEAN; ?>" maxlength="10" readonly>
