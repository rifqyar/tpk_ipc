                    ...
                    templates: {
                        buttons: function() {
                            var options = this.options,
                                html =
                                '<div class="btn-group btn-group-sm btn-group-flat"><a class="btn btn-default" href="#' +
                                this.id +
                                '" data-wizard="back" role="button">' +
                                options.buttonLabels.back +
                                '</a><a class="btn btn-success pull-right" href="#' +
                                this.id +
                                '" data-wizard="finish" role="button">' +
                                options.buttonLabels.finish +
                                '</a><a class="btn btn-default pull-right" href="#' +
                                this.id +
        ...
        function() {
            var defaults = $.components.getDefaults("wizard"),
                options = $.extend(!0, {}, defaults, {
                    step: ".wizard-pane",
                    onInit: function() {
                        this.$progressbar = this.$element.find(
