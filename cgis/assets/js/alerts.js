(function($) {	
	$.alerts = {
		...
		_showPopup: function(title, msg, value, type, callback, data, width, height) {
			...
			body_append+= '			<button type="button" class="close" id="popup_close_popup"><span aria-hidden="true">×</span></button>';
		...
		_showPopupTwo: function(title, msg, value, type, callback, data, width, height){
			...
			body_append+= '	<div class="modal-content">';
			body_append+= '		<div class="modal-header">';
			body_append+= '			<button type="button" class="close" id="popup_close_popup_two"><span aria-hidden="true">×</span></button>';
