...
<head>
	<meta charset="UTF-8">
	<title>Monitoring Percepatan Penarikan</title>
	...
	<div id='loadingmessage' style='display:none' class='se-pre-con' align="center">
	  ...
	  <div class="panel-body">
		<div class="header" align="center">
			<?php //if($title!=""): ?>
				<h2 class="header-title"><?php echo "MONITORING PERCEPATAN PENARIKAN"; ?></h2>
			<?php// endif; ?>
		</div><br>
		...
		<table class="body" cellspacing="1" width="100%" id="table_scroll" style="border:2px" class="table_scroll" style='display:none;'>
			<tr style="text-align:center;">
				...
				<th style="text-align:center;">GATEPASS</th>
				<th style="text-align:center;">PERIKSA</th>
				<th style="text-align:center;">GATEPASS BHD</th>
				<th style="text-align:center;">STATUS KONTAINER</th>
			</tr>
			<?php 
			...
			<tr class="<?php echo $class; ?>">
				...
				<td style="text-align:center;"><?php echo $value->NAMA_DOK; ?></td>
				<td style="text-align:center;font-size:18px;"><?php echo $value->NO_CONT; ?></td>
				<td style="text-align:center;"><?php echo $value->UKR_CONT; ?></td>
				<td style="text-align:center;"><a href="<?php echo site_url('/RequestGatePass/cetak/');echo "?id=".base64_encode($value->ID_REQUEST)."&nocont=".base64_encode($value->NO_CONT);?>" target="_blank"><button class="btn btn-primary btn-sm">CETAK</button></a></td>
				<td style="text-align:center;"><?php echo $value->KETERANGANP; ?></td>
				<td style="text-align:center;"><?php echo $value->STATUS_GATEPASS; ?></td>
