        ...
        <div class="row">
          <div class="col-md-12">
            <div class="radio">
				...
				style=" width:150px; border-radius:5px; border: 2px solid #a1a1a1; height: 35px"><?php echo $row->NO_CONT; ?></button><br><br>
				<?php } ?>
            </div>
          </div>
        </div>
  ...
  ?>
     <div class="container">
        <div class=" col-md-4 form-group">
              ...
              <div class="row">
                <div class=" col-md-12">
                  <select class="form-control" id="trucknya" name="trucknya">
