...
<html>
<body>
<h2 class="page-title" align="center">REPORT DETAIL KEGIATAN</h2>
<br>
<div class="container-fluid">
                        ...
                        <table id="data_table" class="display" style="width:100%">
                            <thead>
                                <tr style="background-color:#3f51b5;">
                                    ...
                                    <th><H6 style="color:white;">Jenis Document</H6></th>
                                    ...
                                    <th><H6 style="color:white;">Lift Off Yard</H6></th>
                                    <th><H6 style="color:white;">Storage Before</H6></th>
                                    <th><H6 style="color:white;">Lift On Stager</H6></th>
                                    <th><H6 style="color:white;">Stripping Restuffing</H6></th>
                                    <th><H6 style="color:white;">Lift On Chassis</H6></th>
                                    <th><H6 style="color:white;">Haulage - Yard</H6></th>
                                    <th><H6 style="color:white;">Lift Off Yard</H6></th>
                                    <th><H6 style="color:white;">Storage After</H6></th>
                                    <th><H6 style="color:white;">Lift On Delivery</H6></th>
                                </tr>
                            </thead>
                            <tbody></tbody>
                             <!-- <tfoot>
            ...
            <div class="modal-body">
                <div class=" col-md-12 form-group">
                    <div class="row">
                        <div class="col-md-offset-1 col-md-10">
                        <?php
                            echo form_open('Report/reportDetail');
                        ?>
                                <div class="form_group form_material">
                                    <div class="col-sm-4" >
                                        <input type="date" class="form-control" id="start_date" name="start_date"><!-- autofocus required> -->
   ...
   <script>
            ...
            var table = $('#data_table').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    "url": "<?php echo site_url('Report/getrange2') ?>",
                    "type": "POST",
                    "data": function(d) {
                ...
                "columns": [
                    ...
                    {"data": "JENIS_DOK", "searchable": true},
                    {"data": "NO_CONT", "searchable": true},
                    {"data": "UKR_CONT", "searchable": true},
                    {"data": "TYPE_CONT", "searchable": true},
                    {"data": "ALAT1", "searchable": true},
                    {"data": "ALAT2", "searchable": true},
                    {"data": "ALAT3", "searchable": true},
                    {"data": "ALAT4", "searchable": true},
                    {"data": "ALAT5", "searchable": true},
                    {"data": "ALAT6", "searchable": true},
                    {"data": "ALAT7", "searchable": true},
                    {"data": "ALAT8", "searchable": true},
                    {"data": "ALAT9", "searchable": true}
            ...
            // $( api.column( 16 ).footer() ).html(monTotal16);
        },
